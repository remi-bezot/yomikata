...
export default function SignUp() {
  ...
  return (
    <KeyboardAvoidingView style={styles.container} >
      ...
      <TextInput onChangeText={(value) => setSignUpname(value)} value={signUpname} style={styles.inputStyles} placeholder="name">
            </TextInput>
    <Text style={styles.inputTitle}>Username</Text>
    <TextInput style={styles.inputStyles} onChangeText={(value) => setSignUpUsername(value)} value={signUpUsername} placeholder='username'>
  </TextInput>
  <Text style={styles.inputTitle}>Email</Text>
      <TextInput onChangeText={(value) => setSignUpemail(value)} value={signUpemail} style={styles.inputStyles} placeholder="email">
            </TextInput>
